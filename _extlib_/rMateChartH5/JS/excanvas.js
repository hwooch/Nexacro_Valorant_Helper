...
(function() {
  ...
  function CanvasRenderingContext2D_(canvasElement) {
    ...
    //overlayEl.style.backgroundColor = 'red'; //by HS
  ...
  function getCoords(ctx, aX, aY) {
    var m = ctx.m_;
    return {
      x: parseFloat(parseFloat(Z * (aX * m[0][0] + aY * m[1][0] + m[2][0]) - Z2).toFixed(10)),
      y: parseFloat(parseFloat(Z * (aX * m[0][1] + aY * m[1][1] + m[2][1]) - Z2).toFixed(10))
    };
  };
